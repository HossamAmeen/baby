                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent"
                                                                ...
                                                                {{--<img style="text-align: center;width: 100px;height: 100px;display: block" height="100px" width="100px" src="{{url('admin/images/MC_logo.png')}}" alt="Mack Clean" title="Mack Clean">--}}
                                                                                                                ...
                                                                                                                <table align="left"
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td align="center"
                                                                                                                            ...
                                                                                                                            {{--<a href="{{$data['google']}}"--}}
                                                                                                                               {{--target="_blank"><img--}}
                                                                                                                                        {{--src="https://cdn-images.mailchimp.com/icons/social-block-v2/outline-light-googleplus-48.png"--}}
                                                                                                                                        {{--style="display:block;"--}}
                                                                                                                                        {{--alt="Google+"--}}
                                                                                                                                        {{--height="24"--}}
                                                                                                                                        {{--width="24"--}}

        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <select class="form-control" name="type" id="type" required>
                    <option value="0" selected> إذن إضافة</option>
    ...
    <script type="text/javascript">
                ...
                if (number.length >= 4) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (parseInt(quantity) === 0 && parseInt(type) === 1)
                                return;
        ...
        function addProduct() {
            if (tempProduct !== null) {
                ...
                let rawHtml = '<tr>' +
                    ...
                    '<td>' + tempProduct.buying_price + '</td>' +
        ...
        function saveOrder() {
            ...
            if (products.length > 0) {
                ...
                form.append('type', $('#type').find('option:selected').val());

                ...
                <div class="col-xs-12 col-md-6">
                    <div class="content">
                        <ul class="nav nav-tabs">
                            <li class="active col-md-6 col-xs-6"><a data-toggle="tab" href="#home"><div class="title bink"><h4><strong>{{trans('site.login')}}</strong></h4></div></a></li>
                            <li class="col-md-6 col-xs-6"><a data-toggle="tab" href="#menu1"><div class="title bink"><h4><strong>{{trans('site.register')}}</strong></h4></div></a></li>
                        </ul>
                            ...
                            <div id="home" class="tab-pane fade in active">
                                <div class="login">
                                    ...
                                    <form role="form" data-toggle="validator" method="POST" action="{{ url('/login') }}" >
                                        ...
                                        <div class="form-group col-xs-12 text-center forget-div">
                                            <a href="{{ url('/register') }}">{{trans('site.new_user')}}</a>
                                        </div>

...
{!! Form::open(['route' => 'vendors.store', 'data-toggle'=>'validator', 'files'=>'true']) !!}
   ...
   <div id="user_data">
      ...
      <div class="form-group select-group">
        ...
        <input type="number" class="form-control" placeholder="{{trans('site.commission')}}" value="0" name="commission" min="0" max="30" required>
      </div>

...
<html lang="ar">
   <header>
    ...
    <body>
          ...
          <p style="text-align: center;">{{ $add->Course->title }}</p>
           <table class="table table-striped table-bordered table-hover"  DIR="RTL" style="border: 1px solid orange;padding: 10px;">
       <thead>
      
       	<th style="border: 1px solid orange;padding: 10px;">الاسم باللغة العربية</th>
       	<th style="border: 1px solid orange;padding: 10px;">الاسم رباعي باللغة اﻷنجليزية</th>
       	<th style="border: 1px solid orange;padding: 10px;">دولة اﻷقامة</th>
        ...
        <th style="border: 1px solid orange;padding: 10px;">المهنة/الوظيفة</th>
        <th style="border: 1px solid orange;padding: 10px;">الرسالة</th>
       </thead>
       <tbody>
       
        <tr>
          <td style="border: 1px solid orange;padding: 10px;text-align: center;"> {{ $add->name_ar }}</td>
          <td style="border: 1px solid orange;padding: 10px;text-align: center;"> {{ $add->name_en }}</td>
          ...
          <td style="border: 1px solid orange;padding: 10px;text-align: center;">{{ $add->job }}</td>

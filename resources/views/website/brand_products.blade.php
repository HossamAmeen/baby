                ...
                <aside>
                    <div class="filter">
                        ...
                        <label for="exampleInputEmail1">price</label>
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <label for="exampleInputEmail1">From (EGP)</label>
                                    <input type="number" class="form-control" id="exampleInputprice" placeholder="From ">
                                </div>
                                <div class="col-xs-6">
                                    <label for="exampleInputEmail1">To (EGP)</label>
                                    <input type="number" class="form-control" id="exampleInputprice" placeholder="To ">
                                </div>
                                </div>
                        </div>
                       <div class="form-group">
                        <label for="exampleInputEmail1">Brand</label>
                           <hr>
                        <input type="text" class="form-control" id="exampleInputbr" placeholder="brand">
                            <div class="checkbox">
                            <label>
                              <input type="checkbox"> Chicco
                            </label><br>
                                <label>
                              <input type="checkbox"> Chicco
                            </label><br>
                        ...
                        @foreach($products as $item)
                                <div class="col-md-3 col-sm-4 col-xs-6 productload proudct1 product">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title"><a href="{{ url($item->link) }}"
                                                                      title="@if($lan == 'ar'){{ $item->title_ar }} @else {{ $item->title }} @endif">
